...
const Life = () => {
  ...
  return (
    <span>
      ...
      <span>
        {" "}
        To clear my mind, I love to run. I ran cross-country in high school but
        never excelled. It wasn't until studying abroad in Edinburgh that I
        found myself really enjoying 5 to 8 mile runs across the Scottish
        hillside. After coming back to the US, I ran my first marathon my senior
        year. The process of training is cathartic and structure building for
        me. Because a friend suggested it, I ran my first 50 mile ultra marathon
        in February of 2019 in Buffalo along the Erie Canal. After swearing we'd
        never do that again, we attempted a 100 mile ultra marathon in Traverse
      ...
      <br></br>
      <span>
        I like to tinker with road/gravel bikes in my spare time. Biking is a
      ...
      <br></br>
      <span>
        Combining running & biking, other friends & I like to do a yearly
      ...
      <br></br>
      <span>
        The ability to work remotely has so far allowed me to spend a month at a
        time in a new location, rather than just a week for vacation. Since
      ...
      <span>
        {" "}
        I grew up in Central Massachusetts in a small town, Brimfield. The city
        has a population of 3,000 but for three time per year, 100,000+ people
        visit throughout the week for the world's largest outdoor antique fair.
        Starting in 7th grade, I began wearing a "Porter for hire" shirt and
