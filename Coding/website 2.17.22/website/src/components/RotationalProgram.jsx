    ...
    <span>
      ...
      <span className="paragraph">
        <span>
          ...
          As a result, I took with a job in a Rotational Leadership Development
        ...
        <br></br>
        <span>
          I rotated between Corporate Development, Warehouse Automation, and TMS
          (Transportation Management System) integration. I spent the bulk of my
          time in the second rotation, implementing a{" "}
          <a href="https://www.youtube.com/watch?v=anuLf5AWR8I">
            KNAPP A-Frame
          </a>
        ...
        <br></br>
        <span>
          It was here that I first learned SQL, learned to model scenarios in
          Excel, and build tools to solve operational challenges. From here, I
          moved to Uber because...
          <ul>
            <li>My friends moved away from New Hampshire</li>
            <li>I wanted to live in a city</li>
            <li>
              I thought that our inbound/outbound transportation management
              process at CS was inefficient, and that Uber Freight seemed to be
              solving this problem well
            </li>
          </ul>
        </span>
        <br></br>
        <span>Find fun pictures of my time at CS below.</span>
