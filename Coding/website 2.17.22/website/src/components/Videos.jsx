  ...
  return (
    <span>
      ...
      <span className="paragraph">
        ...
        <span>
          Over the next few years I entered over 50 video contests that I found
          from the aptly named onlinevideocontests.com and placed in ~25 of them
          (just google “Jason Giroaurd Video Contest”). I found success in
          focusing on the expected value (probability of winning * amount to be
          won), and that poorly advertised contests with under-eighteen
        ...
        <br></br>
        <span>
          From Google to the Illinois Corn Growers Assocation, to Intel, to the
          National Cattlemen’s, I didn’t limit my entries based on what I knew
          or what I was good at — I tailored my content to the judging criteria
          if one was available and treated it as a job. By 18, I had made
          ~$25,000 from video-contests, all of which I used for college. From a
          young age, my foray into video contests probably had the largest
